          ...
          <v-card>
            ...
            <v-card-actions>
              ...
              <v-btn color="blue darken-1" text @click.native="close"
                >Cancelar</v-btn
              >
              <v-btn color="green darken-1" text @click.native="guardar"
                >Guardar</v-btn
              >
            </v-card-actions>
          </v-card>
...
export default {
  ...
  methods: {
    ...
    activar() {
      ...
      let configuracion ={headers : header};
      axios
        .put("api/Categorias/Activar/" + this.adId,{},configuracion).then(function(response) {
          me.adModal = 0;
          me.adAccion = 0;
          me.adNombre = "";
          me.adId = "";
    ...
    desactivar() {
      ...
      let configuracion ={headers : header};
      axios
        .put("api/Categorias/Desactivar/" + this.adId,{},configuracion).then(function (response) {
          me.adModal = 0;
          me.adAccion = 0;
          me.adNombre = "";
          me.adId = "";
