<template>
  <v-layout align-start>
    <v-flex>
      <v-toolbar text color="white">
        ...
        <v-dialog v-model="verArticulos" max-width="1000px">
          <v-card>
                ...
                <v-layout wrap>
                  <v-flex xs12 sm12 md12 lg12 xl12>
                    ...
                    <v-text-field
                      ...
                      class="text-xs-center"
                      v-model="texto"
                      label="Ingrese artículos a buscar"
                    ...
                    <template>
                      ...
                      >
                        ...
                        <template slot="no-data">
                          <h3>No hay artículos agregados para mostrar</h3>
                        </template>
                      </v-data-table>
                    </template>
                  </v-flex>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn @click="ocultarArticulos()" color="blue darken-1" text
                >Cancelar</v-btn
              >
            </v-card-actions>
          </v-card>
      ...
      <!-- Insertamos un layout para registro-->
      <v-container grid-list-sm class="pa-4-white" v-if="verNuevo">
        <v-layout row wrap>
          ...
          <v-flex xs12 sm12 md2 lg2 xl2 v-if="errorArticulo">
...
export default {
  ...
  methods: {
    ...
    eliminarDetalle(arr, item) {
      ...
      if (i !== -1) {
        arr.splice(i, 1); //Splice significa eliminar
      }
    },
    select() {
      let me = this;
